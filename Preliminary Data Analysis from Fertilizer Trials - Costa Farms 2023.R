# SUMMARY
# - beginning analysis for fertilizer performance trials at Costa Farms during the summer of 2023
# - gathered/organized data from excel and performed some statistical tests using R
#
# POSSIBLE IMPROVEMENTS
# - this code was a specific to only a few trials we wanted to focus on... we would change some of the init variables
#   to get our desired outcome, but ideally with more time I would have liked to make it generalized and run the code for all the trials at once
# - it would have been cool to do more data analysis... I ran some simple tests but there was a ton of data yet to be analyzed/compared...
