...
# htAvg <- data.frame(Week=numeric(0),T1=numeric(0),T2=numeric(0),T3=numeric(0),T4=numeric(0))
# phAvg <- data.frame(Week=numeric(0),T1=numeric(0),T2=numeric(0),T3=numeric(0),T4=numeric(0))
# caAvg <- data.frame(Week=numeric(0),T1=numeric(0),T2=numeric(0),T3=numeric(0),T4=numeric(0))
# kAvg <- data.frame(Week=numeric(0),T1=numeric(0),T2=numeric(0),T3=numeric(0),T4=numeric(0))
# no3Avg <- data.frame(Week=numeric(0),T1=numeric(0),T2=numeric(0),T3=numeric(0),T4=numeric(0))
# ecAvg <- data.frame(Week=numeric(0),T1=numeric(0),T2=numeric(0),T3=numeric(0),T4=numeric(0))
# pcAvg <- data.frame(Week=numeric(0),T1=numeric(0),T2=numeric(0),T3=numeric(0),T4=numeric(0))
...
treatments <- c("Week", "Nutricote", "Harrells", "Florikan", "Haifa")

#height
htAvg <- as.data.frame(listAvg[1])
colnames(htAvg) <- treatments
            
htGraph <- gather(htAvg, key = Treatment, value = Measure, Nutricote, Harrells, Florikan, Haifa,) %>%
...
phGraph <- gather(phAvg, key = Treatment, value = Measure, Nutricote, Harrells, Florikan, Haifa,) %>%
  ggplot(aes(x = Week, y = Measure, group = Treatment, colour = Treatment)) + 
  geom_line(size = 1.5) + geom_point(size = 2) +
...
ecGraph <- gather(ecAvg, key = Treatment, value = Measure, Nutricote, Harrells, Florikan, Haifa,) %>%
  ggplot(aes(x = Week, y = Measure, group = Treatment, colour = Treatment)) + 
  geom_line(size = 1.5) + geom_point(size = 2) +
...
pcGraph <- gather(pcAvg, key = Treatment, value = Measure, Nutricote, Harrells, Florikan, Haifa,) %>%
  ggplot(aes(x = Week, y = Measure, group = Treatment, colour = Treatment)) + 
  geom_line(size = 1.5) + geom_point(size = 2) +
