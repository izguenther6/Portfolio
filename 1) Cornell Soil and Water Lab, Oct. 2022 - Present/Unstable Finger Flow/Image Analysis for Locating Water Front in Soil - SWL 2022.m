%{ 
SUMMARY
- aided Naaran Brindt (post-doc, Cornell Soil and Water Lab) in writing this code that was used for the first set of 
  experiments in this paper: https://www.sciencedirect.com/science/article/pii/S0309170824000484
...
- the variable "threshold" was a subjective variable based on what we saw from the output through trial/error... this maybe could have 
  been decided in a more scientific way, but that might have been overkill

- the second argument in the function bwareaopen(arg1, arg2) was also subjective based on output through trial/error... same as the above 
  point, could have been more scientifically derived, but maybe not necessary
%}
